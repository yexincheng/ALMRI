...
if  __name__ == '__main__':
    ...
    for i in range(len(training_pool)):
        ...
        np.save(os.path.join(save_path_loss, f'{args.strategy}_{args.base_model}_{args.sam_model_type}_{num_samples:02d}_{args.seed}_train_loss.npy'), np.array(losses))
        # plot loss
        plt.plot(losses)
